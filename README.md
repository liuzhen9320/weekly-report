...
2. **Weekly** (manual): Trigger the workflow with `mode: weekly` from the [Actions tab](https://github.com/liuzhen9320/weekly-report/actions) to generate a full report with AI narrative.
...
Go to [Actions](https://github.com/liuzhen9320/weekly-report/actions), click **Weekly Report**, then **Run workflow** with `mode: weekly`.
